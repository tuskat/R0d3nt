...
export namespace Images {
    ...
    export class GfxBoss {
        ...
        static getPNG(): string { return require('assets/gfx/boss.png'); }
    }
    export class GfxBottom {
        static getName(): string { return 'bottom'; }

        static getPNG(): string { return require('assets/gfx/bottom.png'); }
    }
    export class GfxBullet {
    ...
    export class GfxFloor {
        ...
        static getPNG(): string { return require('assets/gfx/floor.png'); }
    }
    export class GfxGround {
    ...
    export class GfxSpawn {
        ...
        static getPNG(): string { return require('assets/gfx/spawn.png'); }
    }
    export class GfxTop {
...
export namespace Atlases {
    ...
    export namespace AtlasesDasherNinja {
        export enum Frames {
            Idle0 = 'Idle/00.png',
            Idle1 = 'Idle/01.png',
            Idle2 = 'Idle/02.png',
    ...
    export class AtlasesEnemyNinja {
        static getName(): string { return 'enemy_ninja'; }

        static getJSONArray(): string { return require('assets/atlases/enemy_ninja.json'); }

        static getPNG(): string { return require('assets/atlases/enemy_ninja.png'); }
    }
    export namespace AtlasesEnemyNinja {
        export enum Frames {
            DeathDeath1 = 'Death/Death1.png',
            DeathDeath2 = 'Death/Death2.png',
            DeathDeath3 = 'Death/Death3.png',
            DeathDeath4 = 'Death/Death4.png',
            DeathDeath5 = 'Death/Death5.png',
            IdleIdle1 = 'Idle/Idle1.png',
            IdleIdle2 = 'Idle/Idle2.png',
            IdleIdle3 = 'Idle/Idle3.png',
            IdleIdle4 = 'Idle/Idle4.png',
            RunRun1 = 'Run/Run1.png',
            RunRun2 = 'Run/Run2.png',
            RunRun3 = 'Run/Run3.png',
            RunRun4 = 'Run/Run4.png',
            RunRun5 = 'Run/Run5.png',
            RunRun6 = 'Run/Run6.png',
            SlashSlash1 = 'Slash/Slash1.png',
            SlashSlash2 = 'Slash/Slash2.png',
            SlashSlash3 = 'Slash/Slash3.png',
            SlashSlash4 = 'Slash/Slash4.png',
            SlashSlash5 = 'Slash/Slash5.png',
            SlashSlash6 = 'Slash/Slash6.png',
            SlashSlash7 = 'Slash/Slash7.png',
        }
    }
    export class AtlasesPlayerNinja {
        static getName(): string { return 'player_ninja'; }

        static getJSONArray(): string { return require('assets/atlases/player_ninja.json'); }

        static getPNG(): string { return require('assets/atlases/player_ninja.png'); }
    }
    export namespace AtlasesPlayerNinja {
        export enum Frames {
            BulletBullet1 = 'Bullet/Bullet1.png',
            BulletBullet2 = 'Bullet/Bullet2.png',
            BulletBullet3 = 'Bullet/Bullet3.png',
            BulletBullet4 = 'Bullet/Bullet4.png',
            DashDash1 = 'Dash/Dash1.png',
            DashDash2 = 'Dash/Dash2.png',
            DashDash3 = 'Dash/Dash3.png',
            DashDash4 = 'Dash/Dash4.png',
            DashDash5 = 'Dash/Dash5.png',
            DashDash6 = 'Dash/Dash6.png',
            DeathDeath1 = 'Death/Death1.png',
            DeathDeath2 = 'Death/Death2.png',
            DeathDeath3 = 'Death/Death3.png',
            DeathDeath4 = 'Death/Death4.png',
            DeathDeath5 = 'Death/Death5.png',
            FallFall1 = 'Fall/Fall1.png',
            FallFall2 = 'Fall/Fall2.png',
            FallFall3 = 'Fall/Fall3.png',
            IdleIdle1 = 'Idle/Idle1.png',
            IdleIdle2 = 'Idle/Idle2.png',
            IdleIdle3 = 'Idle/Idle3.png',
            IdleIdle4 = 'Idle/Idle4.png',
            JumpJump1 = 'Jump/Jump1.png',
            JumpJump2 = 'Jump/Jump2.png',
            JumpJump3 = 'Jump/Jump3.png',
            JumpShootJumpShoot1 = 'JumpShoot/JumpShoot1.png',
            JumpShootJumpShoot2 = 'JumpShoot/JumpShoot2.png',
            JumpShootJumpShoot3 = 'JumpShoot/JumpShoot3.png',
            JumpShootJumpShoot4 = 'JumpShoot/JumpShoot4.png',
            JumpShootJumpShoot5 = 'JumpShoot/JumpShoot5.png',
            JumpShootJumpShoot6 = 'JumpShoot/JumpShoot6.png',
            JumpShootJumpShoot7 = 'JumpShoot/JumpShoot7.png',
            JumpShootJumpShoot8 = 'JumpShoot/JumpShoot8.png',
            JumpShootJumpShoot9 = 'JumpShoot/JumpShoot9.png',
            JumpSlashJumpSlash1 = 'JumpSlash/JumpSlash1.png',
            JumpSlashJumpSlash2 = 'JumpSlash/JumpSlash2.png',
            JumpSlashJumpSlash3 = 'JumpSlash/JumpSlash3.png',
            JumpSlashJumpSlash4 = 'JumpSlash/JumpSlash4.png',
            JumpSlashJumpSlash5 = 'JumpSlash/JumpSlash5.png',
            JumpSlashJumpSlash6 = 'JumpSlash/JumpSlash6.png',
            JumpSlashJumpSlash7 = 'JumpSlash/JumpSlash7.png',
            RunRun1 = 'Run/Run1.png',
            RunRun2 = 'Run/Run2.png',
            RunRun3 = 'Run/Run3.png',
            RunRun4 = 'Run/Run4.png',
            RunRun5 = 'Run/Run5.png',
            RunRun6 = 'Run/Run6.png',
            RunShootRunShoot1 = 'RunShoot/RunShoot1.png',
            RunShootRunShoot2 = 'RunShoot/RunShoot2.png',
            RunShootRunShoot3 = 'RunShoot/RunShoot3.png',
            RunShootRunShoot4 = 'RunShoot/RunShoot4.png',
            RunShootRunShoot5 = 'RunShoot/RunShoot5.png',
            RunShootRunShoot6 = 'RunShoot/RunShoot6.png',
            ShootShoot1 = 'Shoot/Shoot1.png',
            ShootShoot2 = 'Shoot/Shoot2.png',
            ShootShoot3 = 'Shoot/Shoot3.png',
            ShootShoot4 = 'Shoot/Shoot4.png',
            ShootShoot5 = 'Shoot/Shoot5.png',
            ShootShoot6 = 'Shoot/Shoot6.png',
            ShootShoot7 = 'Shoot/Shoot7.png',
            ShootShoot8 = 'Shoot/Shoot8.png',
            ShootShoot9 = 'Shoot/Shoot9.png',
            SlashSlash1 = 'Slash/Slash1.png',
            SlashSlash2 = 'Slash/Slash2.png',
            SlashSlash3 = 'Slash/Slash3.png',
            SlashSlash4 = 'Slash/Slash4.png',
            ...
            SlashSlash6 = 'Slash/Slash6.png',
            SlashSlash7 = 'Slash/Slash7.png',
            WallClimbWallClimb1 = 'WallClimb/WallClimb1.png',
        }
    }
    ...
    export namespace AtlasesSlasherNinja {
        export enum Frames {
            Death00 = 'Death/000.png',
            Death01 = 'Death/001.png',
            Death02 = 'Death/002.png',
            Death03 = 'Death/003.png',
            Death04 = 'Death/004.png',
            Idle00 = 'Idle/000.png',
            Idle01 = 'Idle/001.png',
            Idle02 = 'Idle/002.png',
            Idle03 = 'Idle/003.png',
            ...
            Run04 = 'Run/004.png',
            Run05 = 'Run/005.png',
            Slash00 = 'Slash/000.png',
            Slash01 = 'Slash/001.png',
            Slash02 = 'Slash/002.png',
            Slash03 = 'Slash/003.png',
            Slash04 = 'Slash/004.png',
            Slash05 = 'Slash/005.png',
            Slash06 = 'Slash/006.png',
        }
    }
}
